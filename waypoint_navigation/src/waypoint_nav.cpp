...
bool WaypointsNavigation::readFile(const std::string &filename)
{
    ...
    catch(YAML::RepresentationException &e) { return false; }
    return true;
}
...
*/
bool WaypointsNavigation::startNavigationCallback(std_srvs::Trigger::Request &request, std_srvs::Trigger::Response &response)
{
    ...
    if(StartFromTheMiddle)
    {
        ...
        double pre_waypoint_x, pre_waypoint_y;
        double convert_x;
...
*/
bool WaypointsNavigation::resumeNavigationCallback(std_srvs::Trigger::Request &request, std_srvs::Trigger::Response &response)
{
    if(has_activate_)
    {
...
*/
bool WaypointsNavigation::stopNavigationCallback(std_srvs::Trigger::Request &request, std_srvs::Trigger::Response &response)
{
    if(has_activate_)
    {
...
*/
void WaypointsNavigation::cmdVelCallback(const geometry_msgs::Twist &msg)
{
    if(has_activate_ &&
...
*/
void WaypointsNavigation::laserscan_callback(const sensor_msgs::LaserScan &msg)
{
    laserscan = msg;
}
...
*/
void WaypointsNavigation::sendNoObstacleGoal(float first_thresh, float after_second_thresh, float goal_thresh, const geometry_msgs::Pose &dest)
{
    if(laserscan.ranges.size() == 0) return;
...
*/
bool WaypointsNavigation::navigationFinished()
{
...
*/
bool WaypointsNavigation::onNavigationPoint(const geometry_msgs::Point &dest, double dist_err)
{
...
*/
void WaypointsNavigation::publishPoseArray()
{
...
*/
void WaypointsNavigation::setMaxVel()
{
